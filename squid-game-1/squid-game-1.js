...
const seriesNineBtn = document.getElementById("series-nine-btn");
...
seriesTitle.textContent = "Squid Game Season 1 Episode 1 (2021)";
duration.textContent = "59:57";
seriesVid.src = "https://hls.intrdb.com/file/intrdb-cdn/videos/13386/p.m3u8";
document.title = "AndFilm | Squid Game 1 | 1";
})

seriesTwoBtn.addEventListener('click', () => {
seriesTitle.textContent = "Squid Game Season 1 Episode 2 (2021)";
duration.textContent = "1:02:47";
seriesVid.src = "https://hls.intrdb.com/file/intrdb-cdn/videos/13387/p.m3u8";
document.title = "AndFilm | Squid Game 1 | 2";
})

seriesThreeBtn.addEventListener('click', () => {
seriesTitle.textContent = "Squid Game Season 1 Episode 3 (2021)";
duration.textContent = "54:20";
seriesVid.src = "https://hls.intrdb.com/file/intrdb-cdn/videos/13388/p.m3u8";
document.title = "AndFilm | Squid Game 1 | 3";
})

seriesFourBtn.addEventListener('click', () => {
seriesTitle.textContent = "Squid Game Season 1 Episode 4 (2021)";
duration.textContent = "55:08";
seriesVid.src = "https://hls.intrdb.com/file/intrdb-cdn/videos/13529/p.m3u8";
document.title = "AndFilm | Squid Game 1 | 4";
})

seriesFiveBtn.addEventListener('click', () => {
seriesTitle.textContent = "Squid Game Season 1 Episode 5 (2021)";
duration.textContent = "51:50";
seriesVid.src = "https://hls.intrdb.com/file/intrdb-cdn/videos/13593/p.m3u8";
document.title = "AndFilm | Squid Game 1 | 5";
})

seriesSixBtn.addEventListener('click', () => {
seriesTitle.textContent = "Squid Game Season 1 Episode 6 (2021)";
duration.textContent = "1:01:53";
seriesVid.src = "https://hls.intrdb.com/file/intrdb-cdn/videos/13732/p.m3u8";
document.title = "AndFilm | Squid Game 1 | 6";
})

seriesSevenBtn.addEventListener('click', () => {
seriesTitle.textContent = "Squid Game Season 1 Episode 7 (2021)";
duration.textContent = "58:12";
seriesVid.src = "https://hls.intrdb.com/file/intrdb-cdn/videos/13841/p.m3u8";
document.title = "AndFilm | Squid Game 1 | 7";
})


seriesEightBtn.addEventListener('click', () => {
seriesTitle.textContent = "Squid Game Season 1 Episode 8 (2021)";
duration.textContent = "32:29";
seriesVid.src = "https://hls.intrdb.com/file/intrdb-cdn/videos/13861/p.m3u8";
document.title = "AndFilm | Squid Game 1 | 8";
})

seriesNineBtn.addEventListener('click', () => {
seriesTitle.textContent = "Squid Game Season 1 Episode 9 (2021)";
duration.textContent = "55:44";
seriesVid.src = "https://hls.intrdb.com/file/intrdb-cdn/videos/13952/p.m3u8";
document.title = "AndFilm | Squid Game 1 | 9";
})
