...
seriesTitle.textContent = "Squid Game Season 2 Episode 1 (2024)";
duration.textContent = "59:57";
seriesVid.src = "https://hls.armdb.org/file/armdb-hls/videos/85722/f.m3u8";
document.title = "AndFilm | Squid Game 2 | 1";
})

seriesTwoBtn.addEventListener('click', () => {
seriesTitle.textContent = "Squid Game Season 2 Episode 2 (2024)";
duration.textContent = "51:52";
seriesVid.src = "https://hls.armdb.org/file/armdb-hls/videos/85731/f.m3u8";
document.title = "AndFilm | Squid Game 2 | 2";
})

seriesThreeBtn.addEventListener('click', () => {
seriesTitle.textContent = "Squid Game Season 2 Episode 3 (2024)";
duration.textContent = "1:02:09";
seriesVid.src = "https://hls.armdb.org/file/armdb-hls/videos/85754/f.m3u8";
document.title = "AndFilm | Squid Game 2 | 3";
})

seriesFourBtn.addEventListener('click', () => {
seriesTitle.textContent = "Squid Game Season 2 Episode 4 (2024)";
duration.textContent = "1:02:57";
seriesVid.src = "https://hls.armdb.org/file/armdb-hls/videos/85777/f.m3u8";
document.title = "AndFilm | Squid Game 2 | 4";
})

seriesFiveBtn.addEventListener('click', () => {
seriesTitle.textContent = "Squid Game Season 2 Episode 5 (2024)";
duration.textContent = "1:16:17";
seriesVid.src = "https://hls.armdb.org/file/armdb-hls/videos/85805/f.m3u8";
document.title = "AndFilm | Squid Game 2 | 5";
})

seriesSixBtn.addEventListener('click', () => {
seriesTitle.textContent = "Squid Game Season 2 Episode 6 (2024)";
duration.textContent = "52:29";
seriesVid.src = "https://hls.armdb.org/file/armdb-hls/videos/85814/f.m3u8";
document.title = "AndFilm | Squid Game 2 | 6";
})

seriesSevenBtn.addEventListener('click', () => {
seriesTitle.textContent = "Squid Game Season 2 Episode 7 (2024)";
duration.textContent = "1:00:29";
seriesVid.src = "https://hls.armdb.org/file/armdb-hls/videos/85826/f.m3u8";
document.title = "AndFilm | Squid Game 2 | 7";
})
