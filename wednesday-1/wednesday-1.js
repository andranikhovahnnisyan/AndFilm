...
seriesTitle.textContent = "Wednesday 1 Episode 1 (2022)";
duration.textContent = "53:30";
seriesVid.src = "https://hls.intrdb.com/file/intrdb-cdn/videos/34275/p_1.m3u8";
document.title = "AndFilm | Wednesday 1 | 1";
})

seriesTwoBtn.addEventListener('click', () => {
seriesTitle.textContent = "Wednesday 1 Episode 2 (2022)";
duration.textContent = "43:49";
seriesVid.src = "https://hls.intrdb.com/file/intrdb-cdn/videos/34288/p_1.m3u8";
document.title = "AndFilm | Wednesday 1 | 2";
})

seriesThreeBtn.addEventListener('click', () => {
seriesTitle.textContent = "Wednesday 1 Episode 3 (2022)";
duration.textContent = "43:07";
seriesVid.src = "https://hls.intrdb.com/file/intrdb-cdn/videos/34331/p_1.m3u8";
document.title = "AndFilm | Wednesday 1 | 3";
})

seriesFourBtn.addEventListener('click', () => {
seriesTitle.textContent = "Wednesday 1 Episode 4 (2022)";
duration.textContent = "46:28";
seriesVid.src = "https://hls.intrdb.com/file/intrdb-cdn/videos/34413/p_1.m3u8";
document.title = "AndFilm | Wednesday 1 | 4";
})

seriesFiveBtn.addEventListener('click', () => {
seriesTitle.textContent = "Wednesday 1 Episode 5 (2022)";
duration.textContent = "49:21";
seriesVid.src = "https://hls.intrdb.com/file/intrdb-cdn/videos/34414/p_1.m3u8";
document.title = "AndFilm | Wednesday 1 | 5";
})

seriesSixBtn.addEventListener('click', () => {
seriesTitle.textContent = "Wednesday 1 Episode 6 (2022)";
duration.textContent = "45:09";
seriesVid.src = "https://hls.intrdb.com/file/intrdb-cdn/videos/34526/p_1.m3u8";
document.title = "AndFilm | Wednesday 1 | 6";
})

seriesSevenBtn.addEventListener('click', () => {
seriesTitle.textContent = "Wednesday 1 Episode 7 (2022)";
duration.textContent = "42:33";
seriesVid.src = "https://hls.intrdb.com/file/intrdb-cdn/videos/34527/p_1.m3u8";
document.title = "AndFilm | Wednesday 1 | 7";
})


seriesEightBtn.addEventListener('click', () => {
seriesTitle.textContent = "Wednesday 1 Episode 8 (2022)";
duration.textContent = "48:09";
seriesVid.src = "https://hls.intrdb.com/file/intrdb-cdn/videos/34661/p_1.m3u8";
document.title = "AndFilm | Wednesday 1 | 8";
})
