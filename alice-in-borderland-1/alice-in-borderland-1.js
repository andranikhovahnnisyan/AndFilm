...
seriesTitle.textContent = "Alice in Borderland 1 Episode 1 (2020)";
duration.textContent = "48:43";
seriesVid.src = "https://hls.armdb.org/file/armdb-hls/videos/40568/f.m3u8";
document.title = "AndFilm | Alice in Borderland 1 | 1";
})

seriesTwoBtn.addEventListener('click', () => {
seriesTitle.textContent = "Alice in Borderland 1 Episode 2 (2020)";
duration.textContent = "50:51";
seriesVid.src = "https://hls.armdb.org/file/armdb-hls/videos/40577/f.m3u8";
document.title = "AndFilm | Alice in Borderland 1 | 2";
})

seriesThreeBtn.addEventListener('click', () => {
seriesTitle.textContent = "Alice in Borderland 1 Episode 3 (2020)";
duration.textContent = "41:49";
seriesVid.src = "https://hls.armdb.org/file/armdb-hls/videos/40739/f.m3u8";
document.title = "AndFilm | Alice in Borderland 1 | 3";
})

seriesFourBtn.addEventListener('click', () => {
seriesTitle.textContent = "Alice in Borderland 1 Episode 4 (2020)";
duration.textContent = "46:30";
seriesVid.src = "https://hls.armdb.org/file/armdb-hls/videos/40742/f.m3u8";
document.title = "AndFilm | Alice in Borderland 1 | 4";
})

seriesFiveBtn.addEventListener('click', () => {
seriesTitle.textContent = "Alice in Borderland 1 Episode 5 (2020)";
duration.textContent = "51:03";
seriesVid.src = "https://hls.armdb.org/file/armdb-hls/videos/41272/f.m3u8";
document.title = "AndFilm | Alice in Borderland 1 | 5";
})

seriesSixBtn.addEventListener('click', () => {
seriesTitle.textContent = "Alice in Borderland 1 Episode 6 (2020)";
duration.textContent = "40:53";
seriesVid.src = "https://hls.armdb.org/file/armdb-hls/videos/41402/f.m3u8";
document.title = "AndFilm | Alice in Borderland 1 | 6";
})

seriesSevenBtn.addEventListener('click', () => {
seriesTitle.textContent = "Alice in Borderland 1 Episode 7 (2020)";
duration.textContent = "47:32";
seriesVid.src = "https://hls.armdb.org/file/armdb-hls/videos/41573/f.m3u8";
document.title = "AndFilm | Alice in Borderland 1 | 7";
})


seriesEightBtn.addEventListener('click', () => {
seriesTitle.textContent = "Alice in Borderland 1 Episode 8 (2020)";
duration.textContent = "52:14";
seriesVid.src = "https://hls.armdb.org/file/armdb-hls/videos/41590/f.m3u8";
document.title = "AndFilm | Alice in Borderland 1 | 8";
})
