...
seriesTitle.textContent = "Weak Hero 2 Episode 2 (2025)";
duration.textContent = "43:35";
seriesVid.src = "https://hls.armdb.org/file/armdb-hls/videos/90747/p_1.m3u8";
document.title = "AndFilm | Weak Hero 2 | 1";
})

seriesTwoBtn.addEventListener('click', () => {
seriesTitle.textContent = "Weak Hero 2 Episode 2 (2025)";
duration.textContent = "40:42";
seriesVid.src = "https://hls.armdb.org/file/armdb-hls/videos/91296/p_1.m3u8";
document.title = "AndFilm | Weak Hero 2 | 2";
})

seriesThreeBtn.addEventListener('click', () => {
seriesTitle.textContent = "Weak Hero 2 Episode 3 (2025)";
duration.textContent = "40:36";
seriesVid.src = "https://hls.armdb.org/file/armdb-hls/videos/91952/f.m3u8";
document.title = "AndFilm | Weak Hero 2 | 3";
})

seriesFourBtn.addEventListener('click', () => {
seriesTitle.textContent = "Weak Hero 2 Episode 4 (2025)";
duration.textContent = "38:24";
seriesVid.src = "https://hls.armdb.org/file/armdb-hls/videos/92030/f.m3u8";
document.title = "AndFilm | Weak Hero 2 | 4";
})

seriesFiveBtn.addEventListener('click', () => {
seriesTitle.textContent = "Weak Hero 2 Episode 5 (2025)";
duration.textContent = "43:51";
seriesVid.src = "https://hls.armdb.org/file/armdb-hls/videos/92119/p_1.m3u8";
document.title = "AndFilm | Weak Hero 2 | 5";
})

seriesSixBtn.addEventListener('click', () => {
seriesTitle.textContent = "Weak Hero 2 Episode 6 (2025)";
duration.textContent = "42:35";
seriesVid.src = "https://hls.armdb.org/file/armdb-hls/videos/92210/p_1.m3u8";
document.title = "AndFilm | Weak Hero 2 | 6";
})

seriesSevenBtn.addEventListener('click', () => {
seriesTitle.textContent = "Weak Hero 2 Episode 7 (2025)";
duration.textContent = "44:02";
seriesVid.src = "https://hls.armdb.org/file/armdb-hls/videos/92224/p_1.m3u8";
document.title = "AndFilm | Weak Hero 2 | 7";
})


seriesEightBtn.addEventListener('click', () => {
seriesTitle.textContent = "Weak Hero 2 Episode 8 (2025)";
duration.textContent = "54:35";
seriesVid.src = "https://hls.armdb.org/file/armdb-hls/videos/92272/p_1.m3u8";
document.title = "AndFilm | Weak Hero 2 | 8";
})
