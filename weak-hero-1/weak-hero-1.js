...
seriesTitle.textContent = "Weak Hero 1 Episode 1 (2022)";
duration.textContent = "44:14";
seriesVid.src = "https://hls.armdb.org/file/armdb-hls/videos/68973/p_1.m3u8";
document.title = "AndFilm | Weak Hero 1 | 1";
})

seriesTwoBtn.addEventListener('click', () => {
seriesTitle.textContent = "Weak Hero 1 Episode 2 (2022)";
duration.textContent = "42:05";
seriesVid.src = "https://hls.armdb.org/file/armdb-hls/videos/68974/p_1.m3u8";
document.title = "AndFilm | Weak Hero 1 | 2";
})

seriesThreeBtn.addEventListener('click', () => {
seriesTitle.textContent = "Weak Hero 1 Episode 3 (2022)";
duration.textContent = "40:12";
seriesVid.src = "https://hls.armdb.org/file/armdb-hls/videos/68975/p_1.m3u8";
document.title = "AndFilm | Weak Hero 1 | 3";
})

seriesFourBtn.addEventListener('click', () => {
seriesTitle.textContent = "Weak Hero 1 Episode 4 (2022)";
duration.textContent = "38:05";
seriesVid.src = "https://hls.armdb.org/file/armdb-hls/videos/69207/p_1.m3u8";
document.title = "AndFilm | Weak Hero 1 | 4";
})

seriesFiveBtn.addEventListener('click', () => {
seriesTitle.textContent = "Weak Hero 1 Episode 5 (2022)";
duration.textContent = "39:04";
seriesVid.src = "https://hls.armdb.org/file/armdb-hls/videos/70289/p_1.m3u8";
document.title = "AndFilm | Weak Hero 1 | 5";
})

seriesSixBtn.addEventListener('click', () => {
seriesTitle.textContent = "Weak Hero 1 Episode 6 (2022)";
duration.textContent = "40:48";
seriesVid.src = "https://hls.armdb.org/file/armdb-hls/videos/70290/p_1.m3u8";
document.title = "AndFilm | Weak Hero 1 | 6";
})

seriesSevenBtn.addEventListener('click', () => {
seriesTitle.textContent = "Weak Hero 1 Episode 7 (2022)";
duration.textContent = "36:37";
seriesVid.src = "https://hls.armdb.org/file/armdb-hls/videos/70291/p_1.m3u8";
document.title = "AndFilm | Weak Hero 1 | 7";
})


seriesEightBtn.addEventListener('click', () => {
seriesTitle.textContent = "Weak Hero 1 Episode 8 (2022)";
duration.textContent = "42:35";
seriesVid.src = "https://hls.armdb.org/file/armdb-hls/videos/70292/p_1.m3u8";
document.title = "AndFilm | Weak Hero 1 | 8";
})
